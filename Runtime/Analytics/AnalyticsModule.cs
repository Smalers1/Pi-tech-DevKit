...
//   - AnalyticsEquivalenceFixture - the (config+events)->grade golden the cloud mirror must match
//
// REFERENCE DIRECTION (corrected): this assembly references Pitech.XR.Core ONLY. It must NOT reference
// Pitech.XR.Scenario - Scenario ALREADY references Analytics (for SessionStart/StopStep + the config
